...
class ItemEditPage extends StatefulWidget {
  ...
  static final tag = 'item-edit-page';
  static Map item;
...
class _ItemEditPageState extends State<ItemEditPage> {
  ...
  Widget build(BuildContext context) {
    _controllerName.text = ItemEditPage.item['name'];
    ...
    _controllerQtd.text = ItemEditPage.item['quantidade'].toString();
    ...
    _controllerValor.text = ItemEditPage.item['valor'];
    ...
    Container content = Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          Text(
            'Editar: '+ItemEditPage.item['name'].toString().toLowerCase(),
            style: TextStyle(
